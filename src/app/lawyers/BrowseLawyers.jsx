...
const BrowseLawyersPage = () => {
  ...
  useEffect(() => {
    const fetchLawyers = async () => {
      ...
      try {
        const res = await fetch(
          `${process.env.NEXT_PUBLIC_SERVER_URL}/lawyer/profile?search=${search}&specialization=${specialization}&availability=${availability}&fee=${feeRange}`,
          {
            cache: "no-store",
            headers: {
    ...
    fetchLawyers();
  }, [search, specialization, availability, feeRange]);
